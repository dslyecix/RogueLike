...
#pragma warning restore 0414 
        ...
        /// </summary>
        public void SetCollisionSolvingActivation(bool movementSolvingActive)
        {
        ...
        public void UpdatePhase1(float deltaTime)
        {
            ...
            if (_solveMovement)
            {
                ...
                if(InteractiveRigidbodyHandling)
                {
                    ...
                    if (PreserveAttachedRigidbodyMomentum && AttachedRigidbody == null && _lastAttachedRigidbody != null)
                    {
                    ...
                    {
                        _attachedRigidbodyVelocity = GetVelocityFromRigidbodyMovement(AttachedRigidbody, TransientPosition, deltaTime);
